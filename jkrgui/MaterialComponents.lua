...
-----------------------------------------------------------------------------------------------------------------]]
    Com.ComboBox = {
        ...
        Update = function(self, inPosition_3f, inOneCellDimension_3f, inComboContent, inDefaultString, inHeadString)
            ...
            if self.isDropDown then
                self.DropDownButton:Update(vec3(self.mPosition_3f[1].x + self.mDimension_3f[1].x,
                    self.mPosition_3f[1].y, self.mDepth - 5), vec3(self.mDimension_3f[1].y + 5, self.mDimension_3f[1].y,
    ...
    Com.IconButton = {
        ...
        New = function(self, inPosition_3f, inDimension_3f, inIconName)
            ...
            setmetatable(Obj, self)
            self.__index = self
            Obj.mImageButton = Com.ImageLabelObject:NewExisting(inIconName, vec3(inPosition_3f.x, inPosition_3f.y,
                inPosition_3f.z), inDimension_3f)
    ...
    Com.TextButton = {
        New = function(self, inPosition_3f, inDimension_3f, inFont)
            ...
            Obj.Text = Com.TextButtonObject:New("raja", inFont,
                vec3(inPosition_3f.x, inPosition_3f.y, inPosition_3f.z + 20), inDimension_3f)
    ...
    Com.MaterialWindow = {
        ...
        SetCentralComponent = function(self, inComponent)
            ...
            close_button:SetFunctions(function()
            end, function()
            ...
            minimize_button:SetFunctions(function()
            end, function()
